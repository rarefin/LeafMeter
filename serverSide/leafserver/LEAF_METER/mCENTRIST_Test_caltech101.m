...
tr_num  = 30;%80;                     % number of training examples per category
ts_num_max = 5000;%200;%20;              % maximum number of test examples per category 
...
mem_block = 6085;            % maxmum number of testing features loaded each time
...
img_dir ={'M:\mCENTRIST_v1.0\101 caltech\101_ObjectCategories'};       % directory for the image database                             
 
 
 data_dir = 'data/101_ObjectCategories sqrt/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors
split_dir = 'sample_split/101_ObjectCategories';                                                % directory for training and test sample split
