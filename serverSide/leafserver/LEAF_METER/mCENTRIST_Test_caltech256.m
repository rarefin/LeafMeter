...
ts_num_max = 5000;%20;              % maximum number of test examples per category 
...
% 101_ObjectCategories
 ...
 img_dir ={'M:\mCENTRIST_v1.0\256 caltech\256_ObjectCategories'}; 
 
 data_dir = 'data/256_ObjectCategories/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors
split_dir = 'sample_split/256_ObjectCategories';                                                % directory for training and test sample split
