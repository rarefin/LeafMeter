...
ts_num_max = 50;              % maximum number of test examples per category 
tr_split = cell(1,nRounds);   % training sample index 
ts_split = cell(1,nRounds);   % test sample index
mem_block = 35000;            % maxmum number of testing features loaded each time
...
img_dir ={'L:\sun 397\SUN397organized'};       % directory for the image database                             
 
 
 data_dir = 'data/sun 397/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors
split_dir = 'sample_split/67 class indoor';                                                % directory for training and test sample split
