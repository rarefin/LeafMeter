...
ts_num_max = 30;              % maximum number of test examples per category 
...
% img_dir ={'F:\CENTRIST gray_scale\image\Images'};       % directory for the image database                             
% data_dir = 'data/67 class indoor/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors


img_dir ={'E:\SUN397organized'};       % directory for the image database                             
data_dir = 'data/SUN397organized/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors

split_dir = 'sample_split/SUN397organized';                                                % directory for training and test sample split
