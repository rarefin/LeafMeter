...
ts_num_max = 5000;              % maximum number of test examples per category 
...
mem_block = 30000;            % maxmum number of testing features loaded each time
...
% % img_dir ={'F:\CENTRIST gray_scale\image\flowers'};       % directory for the image database                             
% % data_dir = 'data/flowers/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors

% img_dir ={'F:\CENTRIST gray_scale\image\raju segmented_flowers\segmented_flowers'};       % directory for the image database                             
% data_dir = 'data/raju segmented_flowers/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors


% data_dir = 'data/raju bicos segmented_flowers/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors
% img_dir_mask ={'image/raju flower 102 bicos_folding'};       % directory for the image database 


img_dir ={'F:\CENTRIST gray_scale\image\flowers'};       % directory for the image database                             
data_dir = 'data/raju segmented_flowers/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors
img_dir_mask ={'image\raju segmented_flowers\segmented_flowers'};       % directory for the image database 


split_dir = 'sample_split/raju segmented_flowers';                                                % directory for training and test sample split

%% mCENTRIST extraction and saving
% extr_mCENTRIST(img_dir, data_dir, mCENTRIST_model);
% % % extr_mCENTRIST(img_dir, data_dir, mCENTRIST_model,img_dir_mask);
