% Function: scene categorization on the RGB-NIR 9 class scene dataset using mCENTRIST
...
tr_num  = 42;                     % number of training examples per category                     
...
% img_dir ={'image/RGB-NIR 9 class/O1', 'image/RGB-NIR 9 class/O2', 'image/RGB-NIR 9 class/O3',...
%      'image/RGB-NIR 9 class/O4', 'image/RGB-NIR 9 class/Sobel_R'};       % directory for the image database                             
img_dir ={'image/RGB-NIR 9 class/O1', 'image/RGB-NIR 9 class/O2', 'image/RGB-NIR 9 class/O3','image/RGB-NIR 9 class/O4'};       % directory for the image database                             


% img_dir ={'image/RGB-NIR 9 class/O1', 'image/RGB-NIR 9 class/O2'};       % directory for the image database 

% img_dir ={'image/RGB-NIR 9 class/O1', 'image/RGB-NIR 9 class/O2', 'image/RGB-NIR 9 class/O3'};
% img_dir ={'image/RGB-NIR 9 class/R', 'image/RGB-NIR 9 class/G', 'image/RGB-NIR 9 class/B'}; 
data_dir = 'data/RGB-NIR 9 class/mCENTRIST/O1O2O3O4Sobel_m1';           % directory for saving mCENTRIST descriptors


split_dir = 'sample_split/RGB-NIR 9 class';                                                    % directory for training and test sample split
