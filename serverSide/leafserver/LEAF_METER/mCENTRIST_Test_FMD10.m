...
tr_num  = 50;                     % number of training examples per category
ts_num_max = 100;              % maximum number of test examples per category 
...
img_dir ={'F:\CENTRIST gray_scale\image\FMD image\image'};       % directory for the image database                             
img_dir_mask ={'image/FMD image/mask'};       % directory for the image database 
data_dir = 'data/FMD image/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors
split_dir = 'sample_split/FMD image';                                                % directory for training and test sample split
