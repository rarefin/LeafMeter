...
tr_num  = 10;                     % number of training examples per category
ts_num_max= 1000;
...
img_dir ={'M:\mCENTRIST_v1.0\pest image test'};       % directory for the image database          
% img_dir ={'image/8 class event/O1', 'image/8 class event/Sobel_R'};       % directory for the image database                             


data_dir = 'data/NASA/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors
