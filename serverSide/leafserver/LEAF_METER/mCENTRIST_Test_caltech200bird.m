...
tr_num  = 15;%80;                     % number of training examples per category
ts_num_max = 100;%20;              % maximum number of test examples per category 
...
img_dir ={'F:\mCENTRIST_v1.0\mCENTRIST_v1.0\image\Caltech-UCSD Birds images\images'};       % directory for the image database                                   % directory for the image database                             
% annot_dir={'F:\mCENTRIST_v1.0\mCENTRIST_v1.0\image\annotationsBIRD\annotations-mat'};
 
 data_dir = 'data/Caltech-UCSD Birds images/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors
split_dir = 'sample_split/Caltech-UCSD Birds images';                                                % directory for training and test sample split
