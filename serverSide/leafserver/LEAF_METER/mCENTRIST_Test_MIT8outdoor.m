...
tr_num  = 100;                     % number of training examples per category
...
img_dir ={'F:\CENTRIST gray_scale\image\8mit outdoor image'};       % directory for the image database                             
 
 
 data_dir = 'data/8mit outdoor image/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors
split_dir = 'sample_split/8mit outdoor image';                                                % directory for training and test sample split
