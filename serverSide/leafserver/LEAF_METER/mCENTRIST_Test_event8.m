...
tr_num  = 70;                     % number of training examples per category
...
img_dir ={'image/event_img/O3'};       % directory for the image database                             
% img_dir ={'image/8 class event/O1', 'image/8 class event/O2', 'image/8 class event/O3'};       % directory for the image database          
% img_dir ={'image/8 class event/O1', 'image/8 class event/Sobel_R'};       % directory for the image database                             


data_dir = 'data/event_img/mCENTRIST/O1O2O3Sobel_m1';           % directory for saving mCENTRIST descriptors
split_dir = 'sample_split/event_img';                                                % directory for training and test sample splits
